...
public class GameView {
    ...
    public void display(){
        ...
        goLeftButton = new CustomMenuButton(IconUtil.createSizedImageIcon("left.png",30,30));
        goRightButton = new CustomMenuButton(IconUtil.createSizedImageIcon("right.png",30,30));
